          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-center">
                ...
                <a href="https://acrobat.adobe.com/id/urn:aaid:sc:AP:ac0f088c-f654-4396-a6f2-b3f92bf743bf" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:translate-x-1 transition-all duration-200">
                  Resume/CV
                </a>
              </li>
              <li className="flex items-center">
