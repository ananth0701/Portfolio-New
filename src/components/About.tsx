      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="group bg-gray-800 rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 border border-gray-700">
            ...
            <div className="group bg-gray-800 rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 border border-gray-700">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-white mb-3">Technical Expertise</h3>
                  <p className="text-gray-300 leading-relaxed">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-blue-900 text-blue-300 text-xs font-medium rounded-full">Data Visualization</span>
                    <span className="px-3 py-1 bg-blue-900 text-blue-300 text-xs font-medium rounded-full">Tableau</span>
                    <span className="px-3 py-1 bg-blue-900 text-blue-300 text-xs font-medium rounded-full">Machine Learning</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-gray-800 rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 border border-gray-700">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-white mb-3">Project Impact</h3>
                  <p className="text-gray-300 leading-relaxed">
            ...
            <div className="group bg-gray-800 rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 border border-gray-700">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-white mb-3">Recognition & Growth</h3>
                  <p className="text-gray-300 leading-relaxed">
                  ...
                  <div className="mt-4 flex items-center text-sm text-amber-400 font-medium">
          ...
          <div className="lg:sticky lg:top-24 lg:self-start">
            <div className="bg-gray-800 rounded-3xl shadow-2xl p-8 border border-gray-700">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Ananthnath Erukulla</h3>
                ...
                <div className="space-y-4 mb-8">
                  <div className="bg-gray-700 rounded-xl p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-white">7.1/10</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-700 rounded-xl p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-white">Data Visualization & ML</span>
                    </div>
                  </div>
                </div>
